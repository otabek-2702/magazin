...
const buyNowUrl = ref(vm?.appContext.config.globalProperties.buyNowUrl || 'https://themeselection.com/item/sneat-vuetify-vuejs-admin-template/')
...
onMounted(() => {
  ...
  if (marketplace === 'vuetify')
    buyNowUrl.value = 'https://store.vuetifyjs.com/products/sneat-vuetify-vuejs-admin-template'
})
</script>
